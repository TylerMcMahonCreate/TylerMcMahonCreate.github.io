...
\[
Y = (w_p - \frac{D}{2}) \left(\frac{w_0}{w_p}\right)
\]
Where:
...
- **Device in Action**:
  [Embedded YouTube Video of Device Working](https://www.youtube.com/embed/your-video-id)  <!-- replace 'your-video-id' with the actual YouTube video ID -->
